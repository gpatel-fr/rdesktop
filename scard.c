...
static RD_NTSTATUS
scard_read(RD_NTHANDLE handle, uint8 * data, uint32 length, unsigned long offset, uint32 * result)
{
	UNUSED(handle);
	UNUSED(data);
	UNUSED(length);
...
static RD_NTSTATUS
scard_write(RD_NTHANDLE handle, uint8 * data, uint32 length, unsigned long offset, uint32 * result)
{
	UNUSED(handle);
	UNUSED(data);
	UNUSED(length);
