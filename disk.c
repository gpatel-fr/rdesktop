...
static RD_NTSTATUS
disk_read(RD_NTHANDLE handle, uint8 * data, uint32 length, unsigned long offset, uint32 * result)
{
	int n;
...
static RD_NTSTATUS
disk_write(RD_NTHANDLE handle, uint8 * data, uint32 length, unsigned long offset, uint32 * result)
{
	int n;
